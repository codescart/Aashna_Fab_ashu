...
import 'package:aashnafab/Screen/Profile/MyProfile.dart';
import 'package:aashnafab/Screen/ExploreSection/explore.dart';
...
class _DashboardPageState extends State<Dashboard>
  ...
  _getAppBar() {
    ...
    final appBar = AppBar(
      ...
      backgroundColor: Theme.of(context).colorScheme.lightWhite,
      title: _selBottom == 0?
          Image.asset('assets/images/svg/titleicon.png',height: 40,)
          // ? SvgPicture.asset(
